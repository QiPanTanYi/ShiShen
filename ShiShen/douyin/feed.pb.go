...
func (x *DouyinFeedRequest) Reset() {
	*x = DouyinFeedRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_controller_feed_proto_msgTypes[0]
...
func (*DouyinFeedRequest) Descriptor() ([]byte, []int) {
	return file_controller_feed_proto_rawDescGZIP(), []int{0}
}
...
func (x *DouyinFeedResponse) Reset() {
	*x = DouyinFeedResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_controller_feed_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinFeedResponse) Descriptor() ([]byte, []int) {
	return file_controller_feed_proto_rawDescGZIP(), []int{1}
}
...
func (x *Video) Reset() {
	*x = Video{}
	if protoimpl.UnsafeEnabled {
		mi := &file_controller_feed_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Video) Descriptor() ([]byte, []int) {
	return file_controller_feed_proto_rawDescGZIP(), []int{2}
}
...
var File_controller_feed_proto protoreflect.FileDescriptor

var file_controller_feed_proto_rawDesc = []byte{
	0x0a, 0x15, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x2f, 0x66, 0x65, 0x65,
	0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c,
	0x6c, 0x65, 0x72, 0x22, 0x4c, 0x0a, 0x13, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x66, 0x65,
	...
	0x6e, 0x22, 0xa5, 0x01, 0x0a, 0x14, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x66, 0x65, 0x65,
	...
	0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x2e, 0x56, 0x69, 0x64, 0x65,
	...
	0x02, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72,
	0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x06, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x12, 0x19, 0x0a,
	0x08, 0x70, 0x6c, 0x61, 0x79, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x03, 0x20, 0x02, 0x28, 0x09, 0x52,
	0x07, 0x70, 0x6c, 0x61, 0x79, 0x55, 0x72, 0x6c, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x6f, 0x76, 0x65,
	0x72, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x04, 0x20, 0x02, 0x28, 0x09, 0x52, 0x08, 0x63, 0x6f, 0x76,
	0x65, 0x72, 0x55, 0x72, 0x6c, 0x12, 0x25, 0x0a, 0x0e, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74,
	0x65, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x05, 0x20, 0x02, 0x28, 0x03, 0x52, 0x0d, 0x66,
	...
	0x02, 0x28, 0x03, 0x52, 0x0c, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x75, 0x6e,
	0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x69, 0x73, 0x5f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65,
	0x18, 0x07, 0x20, 0x02, 0x28, 0x08, 0x52, 0x0a, 0x69, 0x73, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69,
	0x74, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x08, 0x20, 0x02, 0x28,
	...
	0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x0b, 0x5a, 0x09,
	0x2e, 0x2e, 0x2f, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e,
}

var (
	file_controller_feed_proto_rawDescOnce sync.Once
	file_controller_feed_proto_rawDescData = file_controller_feed_proto_rawDesc
)

func file_controller_feed_proto_rawDescGZIP() []byte {
	file_controller_feed_proto_rawDescOnce.Do(func() {
		file_controller_feed_proto_rawDescData = protoimpl.X.CompressGZIP(file_controller_feed_proto_rawDescData)
	})
	return file_controller_feed_proto_rawDescData
}

var file_controller_feed_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_controller_feed_proto_goTypes = []interface{}{
	(*DouyinFeedRequest)(nil),  // 0: controller.douyin_feed_request
	(*DouyinFeedResponse)(nil), // 1: controller.douyin_feed_response
	(*Video)(nil),              // 2: controller.Video
	(*User)(nil),               // 3: controller.User
}
var file_controller_feed_proto_depIdxs = []int32{
	2, // 0: controller.douyin_feed_response.video_list:type_name -> controller.Video
...
func init() { file_controller_feed_proto_init() }
func file_controller_feed_proto_init() {
	if File_controller_feed_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_controller_feed_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_controller_feed_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_controller_feed_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Video); i {
			case 0:
				return &v.state
			case 1:
		...
		file_controller_feed_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_controller_feed_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_controller_feed_proto_goTypes,
		DependencyIndexes: file_controller_feed_proto_depIdxs,
		MessageInfos:      file_controller_feed_proto_msgTypes,
	}.Build()
	File_controller_feed_proto = out.File
	file_controller_feed_proto_rawDesc = nil
	file_controller_feed_proto_goTypes = nil
	file_controller_feed_proto_depIdxs = nil
}


func Feed(c *gin.Context) {		//gin的proto格式
	c.ProtoBuf(http.StatusOK, DouyinFeedRequest{})
}