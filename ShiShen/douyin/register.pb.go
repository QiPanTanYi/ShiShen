...
// 	protoc        v3.21.9
// source: controller/register.proto
...
func (x *DouyinUserRegisterRequest) Reset() {
	*x = DouyinUserRegisterRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_controller_register_proto_msgTypes[0]
...
func (*DouyinUserRegisterRequest) Descriptor() ([]byte, []int) {
	return file_controller_register_proto_rawDescGZIP(), []int{0}
}
...
func (x *DouyinUserRegisterResponse) Reset() {
	*x = DouyinUserRegisterResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_controller_register_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinUserRegisterResponse) Descriptor() ([]byte, []int) {
	return file_controller_register_proto_rawDescGZIP(), []int{1}
}
...
var File_controller_register_proto protoreflect.FileDescriptor

var file_controller_register_proto_rawDesc = []byte{
	0x0a, 0x19, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x2f, 0x72, 0x65, 0x67,
	0x69, 0x73, 0x74, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x63, 0x6f, 0x6e,
	0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x22, 0x56, 0x0a, 0x1c, 0x64, 0x6f, 0x75, 0x79, 0x69,
	...
	0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x2e, 0x2f, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e,
}

var (
	file_controller_register_proto_rawDescOnce sync.Once
	file_controller_register_proto_rawDescData = file_controller_register_proto_rawDesc
)

func file_controller_register_proto_rawDescGZIP() []byte {
	file_controller_register_proto_rawDescOnce.Do(func() {
		file_controller_register_proto_rawDescData = protoimpl.X.CompressGZIP(file_controller_register_proto_rawDescData)
	})
	return file_controller_register_proto_rawDescData
}

var file_controller_register_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_controller_register_proto_goTypes = []interface{}{
	(*DouyinUserRegisterRequest)(nil),  // 0: controller.douyin_user_register_request
	(*DouyinUserRegisterResponse)(nil), // 1: controller.douyin_user_register_response
}
var file_controller_register_proto_depIdxs = []int32{
...
func init() { file_controller_register_proto_init() }
func file_controller_register_proto_init() {
	if File_controller_register_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_controller_register_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_controller_register_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_controller_register_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_controller_register_proto_goTypes,
		DependencyIndexes: file_controller_register_proto_depIdxs,
		MessageInfos:      file_controller_register_proto_msgTypes,
	}.Build()
	File_controller_register_proto = out.File
	file_controller_register_proto_rawDesc = nil
	file_controller_register_proto_goTypes = nil
	file_controller_register_proto_depIdxs = nil
}
