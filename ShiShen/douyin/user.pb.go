...
func (x *DouyinUserRequest) Reset() {
	*x = DouyinUserRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_controller_user_proto_msgTypes[0]
...
func (*DouyinUserRequest) Descriptor() ([]byte, []int) {
	return file_controller_user_proto_rawDescGZIP(), []int{0}
}
...
func (x *DouyinUserResponse) Reset() {
	*x = DouyinUserResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_controller_user_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinUserResponse) Descriptor() ([]byte, []int) {
	return file_controller_user_proto_rawDescGZIP(), []int{1}
}
...
func (x *User) Reset() {
	*x = User{}
	if protoimpl.UnsafeEnabled {
		mi := &file_controller_user_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*User) Descriptor() ([]byte, []int) {
	return file_controller_user_proto_rawDescGZIP(), []int{2}
}
...
var File_controller_user_proto protoreflect.FileDescriptor

var file_controller_user_proto_rawDesc = []byte{
	0x0a, 0x15, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x2f, 0x75, 0x73, 0x65,
	0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c,
	0x6c, 0x65, 0x72, 0x22, 0x44, 0x0a, 0x13, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x75, 0x73,
	...
	0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x7c, 0x0a, 0x14, 0x64, 0x6f, 0x75,
	...
	0x67, 0x12, 0x24, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x03, 0x20, 0x02, 0x28, 0x0b, 0x32,
	0x10, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65,
	...
	0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x0b, 0x5a, 0x09, 0x2e,
	0x2e, 0x2f, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e,
}

var (
	file_controller_user_proto_rawDescOnce sync.Once
	file_controller_user_proto_rawDescData = file_controller_user_proto_rawDesc
)

func file_controller_user_proto_rawDescGZIP() []byte {
	file_controller_user_proto_rawDescOnce.Do(func() {
		file_controller_user_proto_rawDescData = protoimpl.X.CompressGZIP(file_controller_user_proto_rawDescData)
	})
	return file_controller_user_proto_rawDescData
}

var file_controller_user_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_controller_user_proto_goTypes = []interface{}{
	(*DouyinUserRequest)(nil),  // 0: controller.douyin_user_request
	(*DouyinUserResponse)(nil), // 1: controller.douyin_user_response
	(*User)(nil),               // 2: controller.User
}
var file_controller_user_proto_depIdxs = []int32{
	2, // 0: controller.douyin_user_response.user:type_name -> controller.User
...
func init() { file_controller_user_proto_init() }
func file_controller_user_proto_init() {
	if File_controller_user_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_controller_user_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_controller_user_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_controller_user_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_controller_user_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_controller_user_proto_goTypes,
		DependencyIndexes: file_controller_user_proto_depIdxs,
		MessageInfos:      file_controller_user_proto_msgTypes,
	}.Build()
	File_controller_user_proto = out.File
	file_controller_user_proto_rawDesc = nil
	file_controller_user_proto_goTypes = nil
	file_controller_user_proto_depIdxs = nil
}
